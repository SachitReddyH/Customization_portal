...
from app.routers import auth, villas, categories, options, selections, quotes, admin, interests, drawing_register, space_cust
...
app.include_router(drawing_register.router)
app.include_router(space_cust.router)
